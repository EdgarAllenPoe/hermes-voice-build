...
- The actual button controller is tested independently for debounce, double-click boundaries, long holds and manual stops. Empty manual captures release their allocated slot.
